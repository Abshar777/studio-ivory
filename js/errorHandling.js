      ...
      scrollTrigger: {
        ...
        onEnter: () => {
          if (item.hasAttribute("data-img")) {
            // console.log(item)
            let speedElement = item.querySelector(".speed");
            console.log(speedElement);
            if (speedElement) {
              speedElement.removeAttribute("data-speed");
              console.log(item.querySelector(".speed"));
            }
          }
        },
        onLeaveBack: () => {
          if (item.hasAttribute("data-img")) {
            let speedElement = item.querySelector(".speed");
            if (speedElement) {
              speedElement.setAttribute("data-speed", ".8");
              console.log(item.querySelector(".speed"));
            }
          }
        },
